...
puts " Seeding Course"
## courses for  software engineering 
Course.create([name: "Become A Web Developer", image_url: "https://media.istockphoto.com/id/1201166649/photo/office-responsive-devices-web-design-website.jpg?s=612x612&w=0&k=20&c=w1zX61Nw0p3aguqUj9FFrUV9hl8l67zut_ZhdnB9p-E="])
...
Book.create([
  ...
  ({
   ...
   # creating for Fashion tips course
Course.create([name: "Get Weekly Fashion Tips",image_url:"https://media.istockphoto.com/id/921284684/photo/female-fashion-designer.jpg?s=612x612&w=0&k=20&c=E9KdsoHJG3Yg_cuBi57oZ4QC4khJayaT8x9VYxeOG_o="])
